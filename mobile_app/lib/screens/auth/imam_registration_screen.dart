...
class ImamRegistrationScreen extends StatefulWidget {
  const ImamRegistrationScreen({super.key});

  @override
  State<ImamRegistrationScreen> createState() => _ImamRegistrationScreenState();
}

class _ImamRegistrationScreenState extends State<ImamRegistrationScreen> {
  ...
  Future<void> _handleRegistration() async {
    ...
    if (success && mounted) {
      Navigator.pushReplacementNamed(context, '/imam-home');
    } else if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Imam Registration'),
      ),
      body: SafeArea(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Register to verify charity cases',
                              style: TextStyle(
                                fontSize: 14,
